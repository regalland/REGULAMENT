...
const DATA = [
{
  ...
  { code:'CAP. 5', title:'Reguli de condus / acțiuni cu calul / caruta', articles:[
    ...
    { c:'5.2', t:'Ninja-Horse', ty:'interzis', d:[
    ...
    { c:'5.3', t:'Car-Ram (CR)', ty:'interzis', d:['Interzis: lovirea intenționată a altui vehicul (caruta/cal).'],
      s:['Amenda IC.','Warn + Amenda IC.','Ban 1-7 zile în funcție de gravitate.']},
    { c:'5.4', t:'Blocajele', ty:'permis', d:['Sunt permise doar în afara orașelor și cu maxim 2 carute.'],
      s:['Amenda IC.','Warn + Amenda IC.','Ban 1-7 zile în funcție de gravitate.']}
  ]},
...

{
  ...
  intro:'Condițiile de colaborare cu Sindicatul: conduita între organizații, relația cu poliția, declararea și desfășurarea războiului (beef) și regulile din cele 72 de ore de conflict.',
  chapters:[
  ...
  { code:'CAP. 1', title:'Colaborarea cu Sindicatul', articles:[
    ...
    { c:'SD5', t:'Jaful fără motiv', ty:'interzis', d:[
      ...
      { l:'Exemple de motiv întemeiat', k:'ex', i:['Beef.','Refuzul taxei de vamă Cayo.']}
    ]},
  ...
  { code:'CAP. 2', title:'Condiții de respectat cu Poliția', articles:[
    ...
    { c:'SD9', t:'Dreptul la apel în secție', ty:'obligatie', d:[
      'Când sunteți la secție și cereți dreptul la apel, Sindicatul vă obligă să așteptați în liniște până când un polițist vă dă dreptul și vă preia.'
    ]}
  ]},

  { code:'CAP. 3', title:'Război / Beef între organizații — informații generale', articles:[
    { c:'SD10', t:'Asumarea conflictului', ty:'info', d:[
      'Dacă intrați de bunăvoie într-o ceartă cu o altă organizație, trebuie să vă asumați acest lucru.'
    ]},
    { c:'SD11', t:'Retragerea din război (steagul alb)', ty:'info', d:[
    ...
    { c:'SD12', t:'Declararea oficială și pregătirile', ty:'info', d:[
    ...
    { c:'SD13', t:'Durata și zona de conflict', ty:'permis', d:[
      'Organizațiile au dreptul să se bată 3 zile (72h) oriunde în oraș (fără Cayo), chiar și în zonele publice sau la sedii.'
    ], b:[
  ...
  { code:'CAP. 4', title:'Reguli în perioada celor 3 zile (72h)', articles:[
    { c:'SD14', t:'Programul bătăilor publice', ty:'permis', d:[
      'Bătăile publice se desfășoară doar între orele 20:00-08:00.'
    ]},
    { c:'SD15', t:'Ostatici din organizația rivală', ty:'interzis', d:[
      'Nu aveți voie să luați ostatic un membru din organizația rivală.'
    ]},
    { c:'SD16', t:'Tratamentul celor căzuți în luptă', ty:'interzis', d:[
    ...
    { c:'SD17', t:'Vestimentația oficială', ty:'obligatie', d:[
      'Fiecare familie implicată trebuie să poarte culoarea/vestimentația oficială a organizației pe perioada războiului.'
    ]},
    { c:'SD18', t:'Echipamentul din dotare', ty:'permis', d:[
      'Aveți dreptul să folosiți toate echipamentele din dotare.'
    ]},
    { c:'SD19', t:'Transferuri și membri noi', ty:'interzis', d:[
      'Este interzis orice transfer sau adăugare de membri în organizație pe perioada beef-ului/războiului.'
    ]},
    { c:'SD20', t:'Ieșirea din organizație', ty:'interzis', d:[
  ...
  { code:'CAP. 5', title:'Reguli extra', articles:[
    { c:'SD21', t:'Furtul de haine sau uniforme', ty:'interzis', d:[
      'Este interzis să furați haine/uniforme (haine custom) de la alte organizații.'
    ], s:['Mafia WARN + amendă 20.000.000$.']},
    { c:'SD22', t:'Încheierea jafului și perimetrul', ty:'info', d:[
      'Odată cu încheierea jafului (banii au fost luați și mafioții pleacă, sau orice alt lucru ce ar încheia RP-ul de bătaie din jurul băncii), perimetrul de jaf nu se mai aplică.'
    ], b:[
      { l:'Mențiuni', k:'note', i:[
        'Dacă poliția urmărește suspecții care pleacă de la jaf, trebuie să își asume o posibilă redeschidere a focului în limitele zonelor marcate pe hartă (nu în zone verzi).',
        'Încheierea jafului nu vă permite urmărirea poliției în afara perimetrului doar cu scopul de a-i pica, pentru a vă asigura că nu puteți fi urmăriți ulterior.'
      ]}
    ]}
  ]}
