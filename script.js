...
{
  id:'sindicat', n:'9', icon:'🤝', title:'Regulament Sindicat',
  ...
  { code:'CAP. 1', title:'Colaborarea cu Sindicatul', articles:[
    ...
    { c:'SD5', t:'Jaful fără motiv', ty:'interzis', d:[
      ...
      { l:'Exemple de motiv întemeiat', k:'ex', i:['Beef.','Refuzul taxei de vamă Guarma.']}
    ]},
    { c:'SD6', t:'Amenințări și suferințe OOC', ty:'interzis', d:[
      'Sindicatul vă interzice sub orice formă să faceți amenințări sau suferințe OOC pe baza acțiunilor întâmplate pe server.'
    ]}
  ]},

  { code:'CAP. 2', title:'Condiții de respectat cu Poliția', articles:[
    { c:'SD7', t:'Respectul față de poliție', ty:'obligatie', d:[
      ...
      { l:'Nu aveți voie', k:'forbid', i:['Să îi jigniți.','Să îi instigați.','Să le consumați nervii și timpul.']}
    ]},
    { c:'SD8', t:'Focuri de armă asupra poliției', ty:'interzis', d:[
      'Sindicatul nu vă asigură sub nicio formă protecție dacă deschideți focuri de armă asupra poliției.'
    ]}
  ]},

  { code:'CAP. 3', title:'Război / Beef între organizații — informații generale', articles:[
    { c:'SD9', t:'Asumarea conflictului', ty:'info', d:[
      'Dacă intrați de bunăvoie într-o ceartă cu o altă organizație, trebuie să vă asumați acest lucru.'
    ]},
    { c:'SD10', t:'Retragerea din război (steagul alb)', ty:'info', d:[
    ...
    { c:'SD11', t:'Declararea oficială și pregătirile', ty:'info', d:[
    ...
    { c:'SD12', t:'Durata și zona de conflict', ty:'permis', d:[
      'Organizațiile au dreptul să se bată 3 zile (72h) oriunde în oraș (fără Guarma), chiar și în zonele publice.'
    ], b:[
      { l:'Interzis', k:'forbid', i:['Implicarea civililor în conflict.']}
    ]}
  ]},

  { code:'CAP. 4', title:'Reguli în perioada celor 3 zile (72h)', articles:[
    { c:'SD13', t:'Programul bătăilor publice', ty:'permis', d:[
      'Bătăile publice se desfășoară doar între orele 22:00-07:00.'
    ]},
    { c:'SD14', t:'Ostatici din organizația rivală', ty:'interzis', d:[
      'Nu aveți voie să luați ostatic un membru din organizația rivală.'
    ]},
    { c:'SD15', t:'Tratamentul celor căzuți în luptă', ty:'interzis', d:[
  ...
  { code:'CAP. 6', title:'Condiții de respectat pe Guarma', articles:[
    { c:'SD21', t:'Casa Sindicatului de pe Insula Guarma', ty:'interzis', d:[
      ...
      { l:'Obligatoriu', k:'note', i:['În momentul în care pășiți pe teritoriul Casei Sindicatului nu aveți voie să aveți arma în mână.']}
    ]},
    { c:'SD22', t:'Protecția locațiilor Sindicatului', ty:'permis', d:[
      ...
      { l:'Mențiune', k:'note', i:['Civililor nu li se poate cere să cunoască aceste reguli.']}
    ]},
    { c:'SD23', t:'Raziile poliției', ty:'info', d:[
      'Raziile din partea poliției pot apărea oricând, la orice oră!'
    ]},
    { c:'SD24', t:'Armamentul pe insulă', ty:'obligatie', d:[
      'Fiecare organizație, când este pe Insula Guarma, trebuie să aibă toți membrii armați cu cel mai bun armament.'
    ]},
    { c:'SD25', t:'Răspunderea organizației care protejează insula', ty:'obligatie', d:[
    ...
    { c:'SD26', t:'Taxa de protecție pe familie', ty:'permis', d:[
      'Organizația însărcinată cu protecția Insulei Guarma are dreptul de a cere o taxă de protecție pe familie.'
    ], tr:[
      { k:'Neoficială', v:'2.000.000$ pentru o familie neoficială.' },
      { k:'Oficială', v:'3.000.000$ pentru o familie oficială.' }
    ], s:['Dacă o persoană refuză taxa sau este prinsă după vamă fără taxa plătită, organizația care protejează insula poate sancționa după bunul plac.']}
  ]}
